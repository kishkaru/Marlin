...
// Servos
//
#define SERVO0_PIN                          PA1   // BLTOUCH (Marlin defaults the BLTouch control to the first servo)
...
//
  ...
  #define Z_MIN_PROBE_PIN                   PA2   // BLTOUCH (z-sensing)
#endif
...
#define FAN2_PIN                            PE6   // Fan2 (controller cooling fan)
